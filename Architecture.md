...
| Root Skills | Standalone, harness-agnostic skills | `agent-reach/`, `code-review/`, `find-skills/`, `human-writing/`, `impeccable/`, `kami/`, `minimax-pdf/`, `paper-lookup/`, `research/`, `resolving-merge-conflicts/`, `seedance-25/`, `setup-pre-commit/`, `wizard/` |
